...
namespace Drupal\course_result\Entity\Controller;
...
use Drupal\course_result\Entity\CourseResult;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a list controller for course_result entity.
 *
 * @ingroup course_result
 */
class CourseResultListBuilder extends EntityListBuilder {
  ...
  public function buildHeader() {
    $header['id'] = $this->t('Course result ID');
